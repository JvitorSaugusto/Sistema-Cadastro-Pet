...
public class FileWriteTest01 {
    public static void writing() {
        String[] perguntas = {"1 - Qual o nome e sobrenome do pet?", "2 - Qual o tipo do pet (Cachorro/Gato)?",
    ...
    public static void escreverPulandoLinha(String[] arr, BufferedWriter bw) throws IOException {
